...
2. Create a `.env` file with these contents and replace the DB_PASSWORD field with your db password.
```
...
npm install
```
4. Open `docs/sptravel2020-06-19.sql`, select and copy all and paste it in MySQL Workbench
